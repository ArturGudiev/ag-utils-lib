...
exports.sleep = exports.waitForFirstFileChanges = exports.getInputFromEditor = exports.printSeveralInColorInline = exports.printInColorInline = exports.printInColor = exports.printWithoutNewLine = exports.drawLine = exports.newline = exports.tablifyString = exports.getUserInput = void 0;
...
function printInColor(message, color, newline = true) {
    if (newline) {
        console.log(chalk_1.default.hex(color)(message));
    }
    else {
        process.stdout.write(chalk_1.default.hex(color)(message));
    }
}
exports.printInColor = printInColor;
function printInColorInline(message, color) {
    printInColor(message, color, false);
}
exports.printInColorInline = printInColorInline;
function printSeveralInColorInline(messages) {
    messages.forEach(obj => {
        printInColorInline(obj.message, obj.color);
    });
}
exports.printSeveralInColorInline = printSeveralInColorInline;
function getInputFromEditor(message = '', options = { tempFile: 'C:\\Artur\\temp\\' }) {
    return __awaiter(this, void 0, void 0, function* () {
        if (message) {
            console.log(message);
        }
